...
function cargarProductos() {
    producto.push(new cafe("Perú", 1200, "./assets/peru.png", 001));
    producto.push(new cafe("Colombia", 3200, "./assets/colombia.png", 002));
    producto.push(new cafe("Guatemala", 1900, "./assets/guatemala.png", 003));
    producto.push(new cafe("Papua Nueva Guinea", 1200, "./assets/papua-nueva-guinea.png", 004));
}
cargarProductos();
